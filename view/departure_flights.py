...
def show_airport_list(page, state):
    ...
    for airport in all_selected_airports:
        text = flet.Container(flet.Checkbox(airport[2] + " - " + airport[1] + " (" + airport[3] + ")", visual_density=flet.VisualDensity.COMPACT, on_change=lambda e: add_departure(e, state, page)), data=airport[3])
