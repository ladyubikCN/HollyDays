...
def add_passengers_container(page, state):
    ...
    if page.width > 600:
        passengers_container = flet.Container(padding=flet.Padding.only(right=2), 
                                            expand=True, 
                                            bgcolor=flet.Colors.TRANSPARENT, 
                                            margin=flet.Margin.only(top=-13))
    else:
        passengers_container = flet.Container(padding=flet.Padding.only(right=2), 
                                                    expand=True, 
                                                    bgcolor=flet.Colors.TRANSPARENT)
