...
def add_passengers_container(page, state):
    ...
    passengers_row.controls.append(flet.ElevatedButton("-", width=40, style=flet.ButtonStyle(alignment=flet.Alignment.CENTER), on_click=lambda e:remove_passenger(state, page)))
    passengers_row.controls.append(flet.Text("1"))
    passengers_row.controls.append(flet.ElevatedButton("+", width=40, on_click=lambda e:add_passenger(state, page)))
