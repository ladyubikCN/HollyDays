...
def expand_search_bar(page, state):
    ...
    if page.width < 600: 
        ...
        _filters = flet.Row(expand=True, spacing=0)
    ...
    _filters.controls.append(departure_flights_container)    
    _filters.controls.append(arrival_flights_container)    
    _filters.controls.append(dates_container)

    if page.width > 600:
        _filters.controls.append(nights_container)
        _filters.controls.append(passengers_container)
    else:
        _filters.controls.append(flet.Row([nights_container, passengers_container],
                                            spacing=0,
                                            expand=True))
    ...
    _filters.controls.append(search_button_container)
    ...
    _search_bar = flet.Column(expand=True, spacing=20)
    _search_bar.controls.append(flet.Row(
    ...
    if page.width > 600:
        _hint = flet.Text("Scegli e combina tutti gli aeroporti e tutti gli intervalli di date che vuoi!", 
